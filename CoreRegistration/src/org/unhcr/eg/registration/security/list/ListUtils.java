 ...
 */
package org.unhcr.eg.registration.security.list;
...
public class ListUtils {
     ...
     * @param listImplementation The implementation of List to be used to create
     * the returned sublists
     * @return A list of sublists
     * @throws IllegalArgumentException if the argument maxListSize is zero or a
     * negative number
     * @throws NullPointerException if arguments original or listImplementation
     * are null
     */
    public static final <T> List<List<T>> split(final List<T> original, final int maxListSize,
        ...
        final List<List<T>> lists = new ArrayList<>(maxChunks);
