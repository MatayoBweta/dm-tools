 ...
 */
public class TokenViewer extends JFXPanel {

    final GetTokenProvidedService service = new GetTokenProvidedService();
     ...
     */
    public class GetTokenProvidedService extends Service<ObservableList<DailySales>> {
